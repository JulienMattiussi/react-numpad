...
var DayView = function DayView(_ref2) {
  ...
  return _react["default"].createElement(_react.Fragment, null, _react["default"].createElement(_CalendarUI.CalendarHeader, null, _react["default"].createElement(_CalendarUI.MonthSwitch, null, _react["default"].createElement(_ChevronLeftSharp["default"], {
    onClick: handlePrevMonth
  }), _react["default"].createElement(_CalendarUI.MonthLabel, {
    onClick: function onClick() {
      return updateCalendarView(_CalendarUI.VIEWS.MONTH_VIEW);
    }
  }, calendarMonth.locale(locale).format('MMMM')), _react["default"].createElement(_ChevronRightSharp["default"], {
    onClick: handleNextMonth
  })), _react["default"].createElement(_CalendarUI.YearSwitch, null, _react["default"].createElement(_ChevronLeftSharp["default"], {
    onClick: handlePrevYear
  }), _react["default"].createElement(_CalendarUI.YearLabel, {
    onClick: function onClick() {
      return updateCalendarView(_CalendarUI.VIEWS.YEAR_VIEW);
    }
  }, calendarMonth.locale(locale).format('YYYY')), _react["default"].createElement(_ChevronRightSharp["default"], {
