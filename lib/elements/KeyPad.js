...
const Content = styled(Paper)`
  display: flex;
  flex-direction: ${props => props.theme.global.flexDirection};
...
const IconCheckStyled = styled(IconCheck)`
  height: ${props => `${props.theme.header.buttonSize} !important`};
  width: ${props => `${props.theme.header.buttonSize} !important`};
`;
...
const Header = styled.div`
  ...
  padding: ${props => props.theme.header.paddingTop} ${props => props.theme.header.paddingRight}
    ${props => props.theme.header.paddingBottom} ${props => props.theme.header.paddingLeft};
  align-items: center;
  color: ${props => props.theme.header.primaryColor};
  background: ${props => props.theme.header.backgroundColor};
  user-select: none;
  order: ${props => props.theme.header.order};
`;
...
const Keys = styled.div`
  ...
  order: ${props => props.theme.body.order};
`;
...
const KeyPad = forwardRef(function KeyPad(
  ...
  return (
    <Content position={position} ref={ref} square>
      <Header>
        <NButton>
          <IconCloseStyled onClick={cancel} />
        </NButton>
        <Label>{label}</Label>
